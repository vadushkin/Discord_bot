...
question_for_kek_dela = ["как дела", "как дела?", "как дела бот?", "как дела ботик",
                         ...
                         'как дела аркадий?', 'как дела аркадий'
                         ]
...
kak_dela_from_bot = ['Хреношо',
                     'А как у меня дела, по-твоему? Я читала любимую книгу, а теперь пришлось отвлечься из-за некоторых…',
                     'А ну их на фиг, эти дела, давай следующий вопрос!',
                     ...
                     'А ты угадай с трех раз! Догадаешься – с меня конфетка.',
                     'Дела мои амбивалентно…',
                     'Без успокоительных трудновато.', 'Все дела переданы прокурору.',
                     'короче я посрал ну и все',
                     'норм, ты как?', 'я тебе не робот - я человек',
                     'клеш рояль?',
                     'Как в Донбассе — с женой живут, а я в запасе.',
