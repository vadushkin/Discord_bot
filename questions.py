question_for_kek_dela = ["как дела", 
                         "как дела?", 
                         "как дела бот?",
                         "как дела ботик",
                         'как дела ботик?', 
...
word_from_anekdot = ['анекдот', 'anecdote']
...
kak_dela_from_bot = ['Хреношо',
                     ...
                     'Без успокоительных трудновато. например героин', 
                     'Все дела переданы прокурору.',
                     'короче я посрал ну и все',
                     'дела ахуитьельый!!!',
                     'норм, ты как?', 
                     'я тебе не женщина - я человек', 
                     'ну эээээ, заебитлс',
                     'клеш рояль?',
